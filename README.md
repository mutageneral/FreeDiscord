...
3. Make sure all the dependencies are installed, Windows: `python -m pip install discord.py requests asyncio gitpython` Linux: `pip3 install discord.py requests asyncio gitpython`.
