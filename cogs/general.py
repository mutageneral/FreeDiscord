...
class General(commands.Cog):
    ...
    async def about(self, ctx):
        em = discord.Embed(title = "About FreeDiscord", description = "This bot is based off of/is the FreeDiscord bot made by SKBotNL#2434, its just lag#5452, recall <3#0001, Quirinus#7329, and antistalker#8888.")
